        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Certificate = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetDollars = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BoxOfficeDollars = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OscarNominations = table.Column<byte>(type: "tinyint", nullable: false),
                    OscarWins = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
